...
public class MainController {
	...
	public ModelAndView authenticateUser(@ModelAttribute("user") User user, @RequestParam("name") String name, @RequestParam("password") String pswd) {
		...
		User user1 = userAuthService.GetUserByName(name);
		if(userAuthService.isValidPassword(pswd, user1.getPassword()))
			{
